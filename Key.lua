...
local Config = {
    ...
    ServiceId       = 30262, -- Your PlatoBoost Service ID
    PlatoSecret     = "57ddeff6-bfab-4d4f-8f05-1760443b6781", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "Leonpro8", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    ...
    HubName         = "Sovich hub", -- The main title shown at the top of the GUI
    HubDescription  = "Best script for FPS" -- The text shown below the title
}
